...
INCLUDEPATH += .. ../third_party ../third_party/webrtc ../webrtc \
            ../third_party/wtl/include $(VSInstallDir)\VC\atlmfc\include
...
#CHROMIUM_BUILD
Debug:DEFINES +=_CRT_NONSTDC_NO_WARNINGS _CRT_NONSTDC_NO_DEPRECATE DYNAMIC_ANNOTATIONS_ENABLED=1 \
        WTF_USE_DYNAMIC_ANNOTATIONS=1

Release:DEFINES += _CRT_NONSTDC_NO_WARNINGS _CRT_NONSTDC_NO_DEPRECATE NDEBUG  \
...
LIBS += -L$$DESTDIR -L$$DESTDIR/lib \
        libjingle_xmpphelp.lib -lexpat -llibjingle -ljsoncpp -lcrnss  -lnss_static \
        -lcrnspr -lsqlite3 -licui18n -licuuc -llibjingle_p2p -llibsrtp -llibjingle_media \
        -llibyuv -llibjpeg -lvideo_capture_module -lwebrtc_utility  -laudio_coding_module \
        -lCNG -lcommon_audio -lsystem_wrappers -lcommon_audio_sse2 -lG711 -lG722 \
        ...
        -laudio_processing -laudioproc_debug_proto -lprotobuf_lite -laudio_processing_sse2\
        -laudio_device -llibjingle_sound
